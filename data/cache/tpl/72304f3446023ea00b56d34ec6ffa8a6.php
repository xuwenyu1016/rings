<?php exit;?>001571138630bc34ff314f15e1ab35fe18dd51e7fbbbs:8337:"a:2:{s:8:"template";s:8273:"
                ...
                <div class="am-offcanvas-bar am-offcanvas-bar-flip">
                    <div class="am-offcanvas-content">
                        ...
                        <div class="last-line-text">
                            ...
                            <a href="/list-jiezhi.html" class="clear-filter">清除筛选</a>
                        </div>
...
//            console.log($(this).parent().index() + 1);
            ...
            if($(".tab-two li:nth-child(1)").hasClass("active")){
                console.log("/jiezhi/select/categoryName-1_ringSeries-" + $firstNum + "_ringCategory-" + $SecNum + "_ringMaterial-" + $ThirdNum + "_ringWeight-" + $FourNum + "_ringPrice-" + $FivNum + ".html");
                $('#looseRingGoLink').attr('href',"/jiezhi/select/ringTypes-1_ringSeries-" + $firstNum + "_ringCategory-" + $SecNum + "_ringMaterial-" + $ThirdNum + "_ringWeight-" + $FourNum + "_ringPrice-" + $FivNum + ".html");
//                location.href="/jiezhi/select/categoryName-1_ringWeight-" + $firstNum + "_priceChoose-" + $SecNum + "_ringShape-" + $ThirdNum + "_cutStyle-" + $FourNum + "_ringColor-" + $FivNum + "_ringLightness-" + $SixNum + "_ringClearance-" + $SevNum + "_ringSymmetry-" + $EigNum + "_ringFluorescence-" + $NinNum + ".html";
            }else if($(".tab-two li:nth-child(2)").hasClass("active")){
                console.log("/jiezhi/select/categoryName-2_ringSeries-" + $firstNum + "_ringCategory-" + $SecNum + "_ringMaterial-" + $ThirdNum + "_ringWeight-" + $FourNum + "_ringPrice-" + $FivNum + ".html");
                $('#looseRingGoLink').attr('href',"/jiezhi/select/ringTypes-2_ringSeries-" + $firstNum + "_ringCategory-" + $SecNum + "_ringMaterial-" + $ThirdNum + "_ringWeight-" + $FourNum + "_ringPrice-" + $FivNum + ".html");
//                location.href="/jiezhi/select/categoryName-2_ringWeight-" + $firstNum + "_priceChoose-" + $SecNum + "_ringShape-" + $ThirdNum + "_cutStyle-" + $FourNum + "_ringColor-" + $FivNum + "_ringLightness-" + $SixNum + "_ringClearance-" + $SevNum + "_ringSymmetry-" + $EigNum + "_ringFluorescence-" + $NinNum + ".html";

            }else{
                console.log("/jiezhi/select/categoryName-all_ringSeries-" + $firstNum + "_ringCategory-" + $SecNum + "_ringMaterial-" + $ThirdNum + "_ringWeight-" + $FourNum + "_ringPrice-" + $FivNum + ".html");
                $('#looseRingGoLink').attr('href',"/jiezhi/select/ringTypes-all_ringSeries-" + $firstNum + "_ringCategory-" + $SecNum + "_ringMaterial-" + $ThirdNum + "_ringWeight-" + $FourNum + "_ringPrice-" + $FivNum + ".html");
//                $('#looseRingGoLink').attr('href',"/jiezhi/select/categoryName-all_ringWeight-" + $firstNum + "_priceChoose-" + $SecNum + "_ringShape-" + $ThirdNum + "_cutStyle-" + $FourNum + "_ringColor-" + $FivNum + "_ringLightness-" + $SixNum + "_ringClearance-" + $SevNum + "_ringSymmetry-" + $EigNum + "_ringFluorescence-" + $NinNum + ".html");
...
</script>";s:12:"compile_time";i:1539602630;}";