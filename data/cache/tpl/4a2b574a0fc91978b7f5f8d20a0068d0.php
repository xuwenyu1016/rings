<?php exit;?>001571308104203ec928c7bf3330eea70ef4d26d8e7cs:8058:"a:2:{s:8:"template";s:7994:"<?php $__Template->display("themes/default/head"); ?>
        ...
        <ul class="am-avg-sm-2 am-margin-top-lg ring-container">
            ...
            <li class="am-padding-left-sm">
                <article class="am-padding-left-sm">
                    ...
                    <p class="price am-margin-vertical-xs am-padding-bottom-sm am-text-xl border-bottom">¥<?php echo $contentInfo["price"];?>   <a class="am-text-sm" href="/list-peishi.html">查看更多配饰 >></a></p>
                    ...
                    <div class="detail-info border-bottom am-padding-vertical-sm am-padding-left-xs">
                        ...
                        <p class="am-margin-vertical-xs"><span>尺寸：</span><span><?php echo $contentInfo["size"];?></span></p>
    ...
    <div class="grey-block am-padding-vertical-xl">
        <div class="am-container">
            <ul class="am-avg-sm-3">
                <?php $listList = service("article","Label","contentList",array( "app"=>"Article", "label"=>"contentList", "class_id"=>8, "expand_id"=>3, "limit"=>"3", "order"=>"views desc"));  if(is_array($listList)) foreach($listList as $list){ ?>
                <li>
...
<section class="product-ring-details am-padding-vertical-xl">
    <div class="am-container">
        ...
        <ul class="am-avg-sm-3 am-margin-vertical-lg">
            <li><p class="am-margin-vertical-xs"><span>货号：</span><span><?php echo $contentInfo["commodity"];?></span></p></li>
            <li><p class="am-margin-vertical-xs"><span>材质：</span><span><?php echo $contentInfo["diamondMaterial"];?></span></p></li>
            <!--<li><p class="am-margin-vertical-xs"><span>手寸：</span><span><?php echo $contentInfo["fingerSize"];?></span></p></li>-->
            <li><p class="am-margin-vertical-xs"><span>证书：</span><span><?php echo $contentInfo["paper"];?></span></p></li>
            <li><p class="am-margin-vertical-xs"><span>主钻重量：</span><span><?php echo $contentInfo["mainWeight"];?></span></p></li>
            <li><p class="am-margin-vertical-xs"><span>副钻重量：</span><span><?php echo $contentInfo["subWeight"];?></span></p></li>
...
<?php $__Template->display("themes/default/foot"); ?>";s:12:"compile_time";i:1539772104;}";